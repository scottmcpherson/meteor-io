...
class Setup extends Command {
  ...
  run(args, argv) {
    ...
    console.log();
    console.log('Specify a directory where you would like to store your generators, templates, and config.');
    console.log();
    ...
    if (self.isDir(ioDest)) {
      try {
        ...
        let _adminConfigFilePath = path.join(self._adminRootDir, 'config', 'config.json');
        fs.outputJsonSync(_adminConfigFilePath, { ioPath: ioInstallPath });
